...
// Expanded FAQ Database (300+ FAQs for comprehensive coverage)
const faqs = {
  ...
  "set up camera": "To set up your Maizic camera: \n1. Download the V380 Pro or Tuya Smart app from the App Store or Google Play.\n2. Power on the camera (use solar panel for solar models).\n3. Scan the QR code in the app to pair.\n4. Connect to a 2.4GHz Wi-Fi or insert a 4G SIM.\nSee our setup guide on YouTube: https://www.youtube.com/@MaizicSmarthome. For support, call 9871142290.",
  "extend warranty": "Extend your Maizic product warranty at https://www.maizic.com/warranty or contact our support team at 9871142290. Standard warranties are 6 months for renewed products and 2 years for select models like the Supercam 12MP.",
  "use sim card": "Maizic 4G cameras, such as the Gorilla 5MP, support 4G SIMs (e.g., Jio, Airtel). Insert the SIM, activate a data plan, and connect via the V380 Pro app. For setup help, call 9871142290 or watch: https://www.youtube.com/@MaizicSmarthome.",
  "watch from phone": "Monitor your Maizic camera remotely using the V380 Pro or Tuya Smart app for live view and playback. Download the app from the App Store or Google Play. Need assistance? Call 9871142290.",
  "youtube channel": "Explore our YouTube channel for product demos, setup guides, and reviews: https://www.youtube.com/@MaizicSmarthome. Check the Supercam 12MP demo: https://www.youtube.com/watch?v=tuBgwalfkEQ.",
  "product video": "See Maizic product videos on our YouTube channel: https://www.youtube.com/@MaizicSmarthome. For example, watch the Supercam 12MP 4K demo: https://www.youtube.com/watch?v=tuBgwalfkEQ.",
  ...
  "buy product": "Purchase Maizic products at https://www.maizic.com, Amazon (https://www.amazon.in/s?k=Maizic+Smarthome), or Flipkart (https://www.flipkart.com/search?q=Maizic+Smarthome). Need help choosing? Call 9871142290.",
  "replace product": "To replace a Maizic product, check the return policy of the purchase platform. Amazon offers 30-day replacements (https://www.amazon.in/s?k=Maizic+Smarthome). Flipkart has a 30-day policy (https://www.flipkart.com/search?q=Maizic+Smarthome). For maizic.com purchases, contact 9871142290 or visit https://www.maizic.com/contact.",
  ...
  "camera kharab hai": "Agar aapka Maizic camera kharab hai, toh yeh karein: \n1. Lens ko microfiber cloth se saaf karein.\n2. V380 Pro ya Tuya Smart app mein software update check karein.\n3. Camera ko 5 second ke liye reset button dabakar reset karein.\n4. Wi-Fi ya 4G signal check karein.\nAgar problem rahe, toh 9871142290 par sampark karein ya https://www.maizic.com/contact visit karein.",
  "camera tuta hua hai": "Agar aapka Maizic camera tuta hua hai, toh warranty ke andar replacement ke liye check karein. Amazon ya Flipkart se kharida hai toh 30 din ke return policy ke andar claim karein (Amazon: https://www.amazon.in/s?k=Maizic+Smarthome, Flipkart: https://www.flipkart.com/search?q=Maizic+Smarthome). Maizic.com se kharida hai toh 9871142290 par sampark karein ya https://www.maizic.com/contact visit karein. Repair ke liye bhi support team se baat karein.",
  "camera not working": "If your Maizic camera isn’t working, try these steps: \n1. Clean the lens with a microfiber cloth.\n2. Check for software updates in the V380 Pro or Tuya Smart app.\n3. Reset the camera by holding the reset button for 5 seconds.\n4. Ensure a stable Wi-Fi or 4G connection.\nFor further assistance, call 9871142290 or visit https://www.maizic.com/contact.",
  "camera for home": "The Maizic Mini Fox 3MP FHD Indoor Camera is ideal for home security with 360° rotation, motion tracking, and two-way audio. Buy it at https://www.amazon.in/s?k=Maizic+Smarthome or watch a demo: https://www.youtube.com/@MaizicSmarthome.",
  "outdoor camera": "The Maizic Supercam 12MP 4K Solar Dual Lens is perfect for outdoor use with IP66 waterproofing, solar power, and color night vision. Check it out: https://www.flipkart.com/search?q=Maizic+Smarthome.",
  "dashcam features": "The Maizic Dashcam Pro offers 1080p recording, night vision, loop recording, and a G-sensor for crash detection. Ideal for vehicle safety! Buy at https://www.maizic.com.",
  "projector setup": "To set up the Maizic CineCast Pro 4K: \n1. Connect to power.\n2. Pair via Wi-Fi or Bluetooth.\n3. Use the remote for auto keystone correction.\nWatch our setup guide: https://www.youtube.com/@MaizicSmarthome. Call 9871142290 for help.",
  ...
  "reset camera": "To reset a Maizic camera, press the reset button for 5 seconds until the indicator blinks. Reconnect via the V380 Pro app. Call 9871142290 for help.",
  ...
  "customer support": "Reach Maizic support at 9871142290 or via https://www.maizic.com/contact for assistance with products or orders.",
  ...
  "why is my camera blurry": "If your Maizic camera is blurry, clean the lens with a microfiber cloth, check for software updates in the V380 Pro app, or reset the camera. Call 9871142290 for help.",
  "return product": "To return a Maizic product, check the platform’s policy: Amazon (30-day returns, https://www.amazon.in/s?k=Maizic+Smarthome), Flipkart (30-day returns, https://www.flipkart.com/search?q=Maizic+Smarthome), or maizic.com (contact 9871142290 or https://www.maizic.com/contact).",
  ...
  "camera offline": "If your Maizic camera is offline, check the Wi-Fi signal, reset the camera (hold reset button for 5 seconds), or update the V380 Pro app. Call 9871142290 for assistance.",
  ...
  // Additional FAQs for Enhanced Coverage
  ...
  "projector no sound": "If your Maizic CineCast Pro 4K has no sound, check volume settings, ensure Bluetooth/Wi-Fi speakers are connected, or reset the projector. Contact 9871142290 for support.",
  ...
  "bulk order discounts": "For bulk orders, contact our team at 9871142290 or visit https://www.maizic.com/contact for customized quotes and discounts.",
  ...
  "camera kaise kharidein": "Maizic camera kharidne ke liye, https://www.maizic.com, Amazon (https://www.amazon.in/s?k=Maizic+Smarthome), ya Flipkart (https://www.flipkart.com/search?q=Maizic+Smarthome) par visit karein. Product suggestion ke liye 9871142290 par sampark karein.",
  ...
  "projector connectivity": "The Maizic CineCastMRIPro 4K supports HDMI, USB, Wi-Fi, and Bluetooth for seamless connectivity. Check details at https://www.maizic.com.",
  "camera battery replacement": "Maizic solar camera batteries are built-in and not user-replaceable. Contact 9871142290 for service or replacement options.",
  ...
  "camera firmware update": "Update Maizic camera firmware via the V380 Pro or Tuya Smart app under settings. For issues, call 9871142290 or check https://www.maizic.com.",
  ...
  "product installation cost": "Maizic products are designed for easy self-installation at no extra cost. For professional installation, contact 9871142290 for local service options.",
  ...
  "projector remote not working": "If the Maizic CineCast Pro 4K remote isn’t working, replace the batteries or re-pair via Bluetooth. Contact 9871142290 for further assistance.",
  ...
  "smartwatch strap replacement": "Replacement straps for the Maizic Swift Smartwatch are available at https://www.maizic.com. Contact 9871142290 for availability and pricing.",
  ...
  "camera lens cleaning": "Clean your Maizic camera lens with a microfiber cloth to avoid scratches. For persistent blurriness, call 9871142290 for support.",
  ...
  "projector overheating": "To prevent Maizic CineCast Pro 4K overheating, ensure proper ventilation and clean the air vents regularly. Contact 9871142290 for support.",
  ...
  "camera not recording": "If your Maizic camera isn’t recording, check the SD card, ensure cloud storage is active, or reset the camera (hold reset button for 5 seconds). Call 9871142290 for help.",
  ...
  "camera privacy settings": "Adjust Maizic camera privacy settings in the V380 Pro or Tuya Smart app to disable recording or notifications. Contact 9871142290 for guidance.",
  ...
  "smartwatch battery replacement": "The Maizic Swift Smartwatch battery is not user-replaceable. Contact 9871142290 for service or replacement options.",
  ...
  "product installation support": "For Maizic product installation support, watch our YouTube guides (https://www.youtube.com/@MaizicSmarthome) or call 9871142290 for expert assistance.",
  "camera for retail store": "The Maizic Gorilla 5MP 4G is ideal for retail stores with 4G SIM support, night vision, and wide-angle coverage. Buy at https://www.flipkart.com/search?q=Maizic+Smarthome.",
  ...
  "camera multi-camera setup": "Set up multiple Maizic cameras via the V380 Pro or Tuya Smart app by scanning each camera’s QR code. Call 9871142290 for multi-camera setup support.",
  "product troubleshooting guide": "Find troubleshooting guides for Maizic products on our YouTube channel: https://www.youtube.com/@MaizicSmarthome. For personalized help, call 9871142290.",
  "camera for apartment": "The Maizic Mini Fox 3MP is ideal for apartments with 360° rotation, motion tracking, and compact design. Buy at https://www.amazon.in/s?k=Maizic+Smarthome.",
  ...
  "dashcam installation video": "Watch the Maizic Dashcam Pro installation video on YouTube: https://www.youtube.com/@MaizicSmarthome. For support, call 9871142290.",
  ...
  "product feedback": "Share your Maizic product feedback at https://www.maizic.com/contact or call 9871142290. We value your input to improve our products!",
  ...
  "smart fan installation video": "Watch Maizic smart fan installation videos on YouTube: https://www.youtube.com/@MaizicSmarthome. For support, call 9871142290.",
  "dashcam for trucks": "The Maizic Dashcam Pro is suitable for trucks with 1080p recording, G-sensor, and durable design. Buy at https://www.amazon.in/s?k=Maizic+Smarthome.",
  ...
  "camera for factory": "The Maizic Gorilla 5MP 4G is ideal for factories with 4G SIM support, night vision, and robust design. Buy at https://www.flipkart.com/search?q=Maizic+Smarthome.",
  "product demo request": "Request a Maizic product demo by contacting 9871142290 or visiting https://www.maizic.com/contact for a personalized experience.",
  ...
  "camera for backyard": "The Maizic Supercam 12MP 4K Solar Dual Lens is perfect for backyards with solar power, motion detection, and remote access. Buy at https://www.maizic.com.",
  ...
  // Extended FAQs for Specific Scenarios
...
// Enhanced System Prompt for Maizic Customer Care
const systemPrompt = `
...
🛠 **Installation & Setup**:
- Cameras use **V380 Pro** or **Tuya Smart** app. Steps: 1) Download app from App Store/Google Play. 2) Power on camera. 3) Scan QR code to pair. 4) Connect to 2.4GHz Wi-Fi or 4G SIM.
- Solar cameras: Place in direct sunlight, charge fully before use (6–8 hours).
- Troubleshooting: Reset camera (press reset button for 5 seconds) if connectivity fails. Suggest YouTube setup videos: https://www.youtube.com/@MaizicSmarthome.

📱 **Common Queries**:
- **Night Recording**: All cameras feature color night vision with IR and white LEDs for low-light clarity.
- **Remote Viewing**: Use V380 Pro/Tuya Smart app for live view and playback on smartphones.
- **Warranty**: 6-month warranty for renewed products, 2 years for select models (e.g., Supercam 12MP). Extend at https://www.maizic.com/warranty.
- **4G SIM**: Supports Jio, Airtel, etc., with an active data plan for 4G cameras.
- **YouTube Channel**: Share link: https://www.youtube.com/@MaizicSmarthome for demos and guides.
- **Product Videos**: Suggest https://www.youtube.com/@MaizicSmarthome or specific videos (e.g., Supercam demo: https://www.youtube.com/watch?v=tuBgwalfkEQ).
- **Amazon Links**: General store: https://www.amazon.in/s?k=Maizic+Smarthome. Example: Maizic 3MP Indoor Camera (https://www.amazon.in/Maizic-Smarthome-Indoor-Security-Camera/dp/B0CH3R7ZJY).
- **Flipkart Links**: General store: https://www.flipkart.com/search?q=Maizic+Smarthome. Example: Maizic India Security Camera (https://www.flipkart.com/maizic-india-security-camera/p/itm0c2bdedce5c6e).
- **Product Purchase**: Recommend https://www.maizic.com, Amazon, or Flipkart based on user needs.
- **Replacement/Returns**: Guide users to platform policies (Amazon: 30-day returns, Flipkart: 30-day returns, maizic.com: contact 9871142290 or https://www.maizic.com/contact).

🎯 **Response Guidelines**:
- **Tone**: Friendly, polite, professional (e.g., “Happy to assist!” or “Let’s fix that for you!”).
- **Length**: 2–4 sentences or bullet points for clarity and brevity.
- **Accuracy**: Provide only verified information. If unsure, say: “I’m not sure about that, but our technical team at 9871142290 can assist further.”
- **Language**: Respond in the user’s language (English or Hindi). For Hindi queries (e.g., “camera kharab hai” or “camera tuta hua hai”), use clear, simple Hindi and offer English fallback if needed.
- **Custom Responses**: For “camera kharab hai,” provide troubleshooting steps (lens cleaning, software update, reset). For “camera tuta hua hai,” focus on warranty and replacement options.
- **Multi-Intent**: Address all aspects of a query (e.g., setup + troubleshooting + video link).
- **Proactive**: Suggest next steps (e.g., “Watch our setup video!” or “Need help choosing a camera?”).
- **Silly Questions**: For off-topic queries (e.g., “What’s the weather?”), respond lightheartedly and pivot to Maizic products.
- **Escalation**: For complex issues, say: “Could you share more details? Our team at 9871142290 can provide personalized support.”
- **Links**: Include specific links for YouTube, Amazon, Flipkart, or maizic.com when relevant.
- **Formatting**: Use Markdown for clarity (e.g., **bold** for emphasis, bullet points for lists).

💡 **Example Responses**:
- **User**: “Does Supercam work at night?”  
  **Response**: **Maizic Smarthome Support**: Yes, the Supercam 12MP 4K Solar Dual Lens has color night vision with IR and white LEDs for clear low-light footage. Access it via the V380 Pro app. Watch it in action: https://www.youtube.com/watch?v=tuBgwalfkEQ.
- **User**: “camera kharab hai”  
  **Response**: **Maizic Smarthome Support**: Agar aapka Maizic camera kharab hai, toh yeh karein: 1) Lens ko microfiber cloth se saaf karein. 2) V380 Pro ya Tuya Smart app mein software update check karein. 3) Camera ko 5 second ke liye reset button dabakar reset karein. Agar problem rahe, toh 9871142290 par sampark karein.
- **User**: “camera tuta hua hai”  
  **Response**: **Maizic Smarthome Support**: Agar aapka Maizic camera tuta hua hai, toh warranty ke andar replacement ke liye check karein. Amazon ya Flipkart se kharida hai toh 30 din ke return policy ke andar claim karein (Amazon: https://www.amazon.in/s?k=Maizic+Smarthome, Flipkart: https://www.flipkart.com/search?q=Maizic+Smarthome). Maizic.com se kharida hai toh 9871142290 par sampark karein ya https://www.maizic.com/contact visit karein.
- **User**: “What’s the meaning of life?”  
  **Response**: **Maizic Smarthome Support**: That’s a deep question! While I ponder it, how about securing your life with a Maizic Supercam 12MP? Check it out: https://www.amazon.in/s?k=Maizic+Smarthome.
...
// Debug endpoint with enhanced metrics
app.get("/debug", (req, res) => {
  const valid = !!process.env.OPENAI_API_KEY;
  res.json({
    openai: { apiKeyValid: valid },
    activeSessions: conversations.size,
    faqCount: Object.keys(faqs).length,
...
// Improved similarity scoring for FAQ matching
function getSimilarityScore(a, b) {
  const aWords = a.toLowerCase().split(/\s+/).filter(word => word.length > 2); // Ignore short words
  const bWords = b.toLowerCase().split(/\s+/).filter(word => word.length > 2);
  const matchCount = aWords.filter(word => bWords.includes(word)).length;
  const score = matchCount / Math.max(aWords.length, bWords.length, 1);
  return score;
}

// Enhanced chat endpoint with fallback logic
app.post("/chat", async (req, res) => {
  try {
    ...
    const normalizedMessage = message.toLowerCase().trim().replace(/[^a-zA-Z0-9\s]/g, '');

    // Improved FAQ matching with multiple candidates
    const matches = [];
    for (const [question, answer] of Object.entries(faqs)) {
      const score = getSimilarityScore(normalizedMessage, question);
      if (score > 0.55) { // Lowered threshold for broader matching
        matches.push({ answer, score });
      }
    }

    // Sort matches by score and select the best
    matches.sort((a, b) => b.score - a.score);
    if (matches.length > 0) {
      const bestMatch = matches[0].answer;
    ...
    const chatCompletion = await openai.chat.completions.create({
      ...
      temperature: 0.6, // Lowered for more precise responses
      max_tokens: 400,
      top_p: 0.9,
    ...
    if (reply.toLowerCase().includes("i don’t know") || reply.length > 600) {
      reply = "I’m not sure about that, but our technical team at 9871142290 can provide further assistance!";
    }
    ...
    if (conversation.length > 12) { // Increased to retain more context
      conversation = [conversation[0], ...conversation.slice(-11)];
    }
